...
class AppButtonPadding {
  ...
  static EdgeInsetsGeometry fromButtonHeights(int buttonHeights) {
...
class AppButtonIconSize {
  static double fromButtonHeights(int buttonHeights) {
